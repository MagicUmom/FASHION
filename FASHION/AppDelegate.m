...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [GMSServices provideAPIKey:@"AIzaSyDhWy86SmdEF6EV6wP1MwJStXmGusJLvno"];
    ...
    NSString *src = [[NSBundle mainBundle]pathForResource:@"stone" ofType:@"db"];
    
    NSString *dst = [NSString stringWithFormat:@"%@/Documents/tmp/stone.db",NSHomeDirectory()];
